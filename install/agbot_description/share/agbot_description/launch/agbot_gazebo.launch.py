...
def generate_launch_description():
    ag_robot_description = get_package_share_directory('agbot_description')
    ag_robot_description_share = get_package_prefix('agbot_description')
    ...
    model_arg = DeclareLaunchArgument(name='model', default_value=os.path.join(
                                        ag_robot_description, 'urdf', 'agbot.urdf.xacro'
                                        ),
